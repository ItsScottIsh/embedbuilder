var params = new URL(location).searchParams,
    ...
    json = {
        content: "ТЫ не ~~можешь~~ сделать `так`.```py\nИ так\nprint('Привет')```\n*italics* или _italics_     __*underline italics*__\n**bold**     __**underline bold**__\n***bold italics***  __***underline bold italics***__\n__underline__     ~~Strikethrough~~",
        embed: {
            title: "Привет ~~челики~~ пиплы :wave:",
            description: "Вы ещё можете использовать [ссылки](https://discord.com) или эмодзи :smile: 😎\n```\nА также кодовые блоки\n```",
            color: 4321431,
            ...
            author: {
                name: "Имя автора",
                url: "https://discord.com",
                icon_url: "https://static.wikia.nocookie.net/discord-wikia/images/5/5e/Default.png/revision/latest/scale-to-width-down/256?cb=20191215094354&path-prefix=ru"
            },
            thumbnail: {
